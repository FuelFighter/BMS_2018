/*
	This header file is mostly directly copied from the example header given by Linear Technology. I simply chose the parts the BMS needs, and copy-pasted those lines.
*/
